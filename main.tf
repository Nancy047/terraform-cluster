...
resource "google_project_iam_member" "default" {
  ...
  member  = "serviceAccount:service-account-basic@gcp-sa-container-cluster-basic.iam.gserviceaccount.com"
}
...
resource "google_project_iam_binding" "default" {
  ...
  members = [
    "serviceAccount:service-account-basic@gcp-sa-container-cluster-basic.iam.gserviceaccount.com",
  ]
}
