...
resource "google_project_iam_member" "default" {
  ...
  member  = "serviceAccount:service-account-basic@gcp-sa-cloud-run.iam.gserviceaccount.com"
}
...
resource "google_project_iam_binding" "default" {
  ...
  members = [
    "serviceAccount:service-account-basic@gcp-sa-cloud-run.iam.gserviceaccount.com",
  ]
}
...
resource "google_project_iam_binding" "default" {
  ...
  role    = "roles/iam.serviceAccountTokenCreator"
  members = [
    "serviceAccount:service-account-basic@gcp-sa-cloud-run.iam.gserviceaccount.